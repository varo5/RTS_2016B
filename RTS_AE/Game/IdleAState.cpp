#include "stdafx.h"
#include "IdleAState.h"


CIdleAState::CIdleAState()
{
...
void CIdleAState::Init(aeStateMachineScript* pScript)
{
	SetWorldReference((aeWorld*)((CAnimationStateMachine*)pScript)->pPassAlong);
}

void CIdleAState::Destroy()
{
}

int CIdleAState::OnUpdate(float fDelta, aeBaseClass * pObject)
{
...
void CIdleAState::OnEnter()
{
}

void CIdleAState::OnExit()
{
}
