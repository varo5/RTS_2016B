#include "stdafx.h"
#include "MoveToAState.h"


CMoveToAState::CMoveToAState()
{
...
void CMoveToAState::Init(aeStateMachineScript* pScript)
{
	SetWorldReference((aeWorld*)((CAnimationStateMachine*)pScript)->pPassAlong);
}

void CMoveToAState::Destroy()
{
}

int CMoveToAState::OnUpdate(float fDelta, aeBaseClass * pObject)
{
...
void CMoveToAState::OnEnter()
{
}

void CMoveToAState::OnExit()
{
}
